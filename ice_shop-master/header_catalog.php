    ...
    <div class="header_main">
        <nav class="main_navigation">
            <div class="main_navigation_left">
                <img src="../src/img/general_images/logo_gllacy.svg" width="154" height="64" alt="Логотип Gllacy">
            ...
            <div class="main_navigation_right">
                <ul class="site_movement current_movement">
                    ...
                    <li>
                        <a class="button btn_cart full" href="#"><img src="../src/img/catalog_images/basket-red.svg"
                                                                      width="21"
