...
import logoApp from '../../img/general_images/logo_glaccy.svg';
import basket from '../../img/catalog_images/basket-red.png';
                ...
                <div className="header_main">
                    <nav className="main_navigation">
                        <div className="main_navigation_left">
                            <img src={logoApp} width="154" height="64" alt="Логотип Gllacy"/>
                            <ul className="site_navigation">
                                <li><a href="ksv3d.ru" className="main current">Каталог</a>
                                    <ul className="main_menu">
                                        <li><a href="ksv3d.ru">Новинки</a></li>
                                        <li><a href="ksv3d.ru">Сливочное</a></li>
                                        <li><a href="ksv3d.ru">Щербеты</a></li>
                                        <li><a href="ksv3d.ru">Фруктовый лед</a></li>
                                        <li><a href="ksv3d.ru">Мелорин</a></li>
                                    </ul>
                                </li>
                                <li><a href="ksv3d.ru">Доставка и оплата</a></li>
                                <li><a href="ksv3d.ru">О Компании</a></li>
                            </ul>
                        </div>


                        <div className="main_navigation_right">
                            <ul className="site_movement current_movement">
                                <li>
                                    <a className="button btn_search" href="ksv3d.ru">
                                ...
                                <li>
                                    <a className="button btn_login" href="ksv3d.ru">
                                    ...
                                    <form className="login_popup" action="https://echo.htmlacademy.ru" method="post">
                                        ...
                                        <div className="user_control">
                                            ...
                                            <div className="for_login">
                                                <a href="ksv3d.ru">Забыли пароль?</a>
                                                <a href="ksv3d.ru">Новая регистрация</a>
                                            </div>
                                        </div>
                                    </form>
                                </li>
                                <li>
                                    <a className="button btn_cart full" href="ksv3d.ru"><img src={basket}
                                        width="21"
                    ...
                    <div className="header_bottom">
                        <ul className="breadcrumbs">
                            ...
                            <li className="breadcrumbs_current">Сливочное</li>
                        </ul>
